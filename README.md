DOOM prBoom mod for TTGO T8 v1.7.1 N4R8 with sdcard reader on board. Use ESP-idf 4.4. New one does not fly for that proj.
...
TFT ST7789 off cause you can move youself
(LCD pins   GPIO):
LCD_CS     io5,
LCD_CLK    io18,
LCD_MISO   io19,
